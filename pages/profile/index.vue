                    ...
                    <div class="post_info">
                        ...
                        <div class="interaction">
                          ...
                          <div class="div_commnets" @click="createComment">
                            ...
                            <p class="quantity_like" >{{ parseNumber(0) }}</p>
                          </div>
...
onMounted ( async () => {
  ...
  for (const p of data) {
    await api.addView(p.post.id);

    let like = await api.getUserPostLike(Number(user.userId), p.post.id)
    ...
    let disLike = await api.getUserPostDislike(Number(user.userId), p.post.id)
